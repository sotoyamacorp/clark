...
export const founders: FounderProfile[] = [
  {
    ...
    bio: {
      ja: [
        ...
        '現在は、マニラの高級エリア「ロックウェル」がマニラ以外で初めて手がける同コンセプトのプロジェクトとして、アンヘレス(クラーク)のコンドミニアムを所有しています(建設中、2027年2月引き渡し予定)。直近では1歳の息子をフィリピンに連れて行き、英語力はもちろん、フィリピンで過ごす時間を持ってほしいと強く感じました。',
