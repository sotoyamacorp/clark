...
export const founders: FounderProfile[] = [
  {
    ...
    bio: {
      ja: [
        ...
        '現在は、マニラの高級エリア「ロックウェル」がマニラ以外で初めて手がける同コンセプトのプロジェクトとして、アンヘレス(クラーク)のコンドミニアムを所有しています(建設中、2027年2月引き渡し予定)。直近では1歳の息子をフィリピンに連れて行き、英語力はもちろん、フィリピンで過ごす時間を持ってほしいと強く感じました。今後は家族でもパンパンガ(アンヘレス・クラーク)を拠点にしていきたいと考えています。',
      ...
      en: [
        ...
        "I now own a condominium in Angeles (Clark) — Rockwell's first project outside Manila, built on the same concept as its upscale Manila development (still under construction, with handover expected in February 2027). Bringing my one-year-old son to the Philippines recently made me want him to grow up with real time spent there, not just the language. Going forward, I'd like our family to make Pampanga (Angeles/Clark) a base as well.",
